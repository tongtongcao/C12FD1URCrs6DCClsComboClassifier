The package is to train classifier to predict if a 6-DC-cluster + 1-uRWell-cross combo belongs to a track candidate by Multi-Layer Perceptron (MLP).\
...
For the estimator, inputs are average wires and slopes of 6 DC clusters, and x & y of uRWell crosses, where average wires are divided by 112, x of uRWell cross is divied by 140, and y of uRWell cross is divided by 160 for normalization,  
